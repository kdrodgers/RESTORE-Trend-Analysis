...
pdf(file = "April_1949_results.pdf")
for (i in 1:length(site_vec1)) {
  ...
  #results
  results <- plotQuantileKendallResults(eList, startDate = "1949-04-01", endDate = "2016-03-31", paStart = 4,
                      paLong = 12,legendLocation = NA )
  fileName <- paste("QK_results_1949.", site_vec1[i],".RDS", sep="")
  saveRDS(results, file = fileName)
  write.xlsx(results, file = "QK_results_1949.xls",
